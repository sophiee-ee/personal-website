! function(a) {
    ...
    function u(r, t, e, n) {
        ...
        this.text = r, this.level = t, this.version = e, this.moduleCount = h, this.isDark = function(r, t) { return t -= n, !((r -= n) < 0 || i <= r || t < 0 || i <= t) && o.isDark(r, t) }, this.addBlank = function(a, u, f, c) {
            var s = this.isDark,
                l = 1 / h;
    ...
    function g(r, t, e, n, o) { e = Math.max(1, e || 1), n = Math.min(40, n || 40); for (var i = e; i <= n; i += 1) try { return new u(r, t, i, o) } catch (r) {} }
    ...
    function c(r, t, e, n, o, i, a, u) { r.isDark(a, u) && t.rect(n, o, i, i) }
        ...
        return i(e, o, t),
            function(r, t, e) {
                ...
                for (l && 0 < e.radius && e.radius <= .5 && (u = s), t.beginPath(), n = 0; n < i; n += 1)
                    for (o = 0; o < i; o += 1) { u(r, t, e, e.left + o * a, e.top + n * a, a, n, o) }
                if (d(e.fill).is("img")) {
    ...
    function t(r) { return e(d("<canvas/>").attr("width", r.size).attr("height", r.size), r) }

    function n(r) {
        return o && "canvas" === r.render ? t(r) : o && "image" === r.render ? function(r) { return d("<img/>").attr("src", t(r)[0].toDataURL("image/png")) }(r) : function(r) {
            ...
            for (i && h.css("background-color", i), e = 0; e < u; e += 1)
                for (n = 0; n < u; n += 1) t.isDark(e, n) && d("<div/>").css(l).css({ left: c + n * f, top: c + e * f }).appendTo(h);
            return h
        }(r)
    }
    var r, d = jQuery,
    ...
    d.fn.qrcode = function(r) { var t = d.extend({}, f, r); return this.each(function() { "canvas" === this.nodeName.toLowerCase() ? e(this, t) : d(this).append(n(t)) }) }
}(function() {
    var r, t = function() {
        function w(n, o) {
            if (void 0 === n.length) throw new Error(n.length + "/" + o);
            var t = function() { for (var r = 0; r < n.length && 0 == n[r];) r += 1; for (var t = new Array(n.length - r + o), e = 0; e < n.length - r; e += 1) t[e] = n[e + r]; return t }(),
                i = {
                    getAt: function(r) { return t[r] },
                    ...
                    mod: function(r) { if (i.getLength() - r.getLength() < 0) return i; for (var t = b.glog(i.getAt(0)) - b.glog(r.getAt(0)), e = new Array(i.getLength()), n = 0; n < i.getLength(); n += 1) e[n] = i.getAt(n); for (n = 0; n < r.getLength(); n += 1) e[n] ^= b.gexp(b.glog(r.getAt(n)) + t); return w(e, 0).mod(r) }
                };
            return i
        }

        function o(r, t) {
            function o(r, t) { s = function(r) { for (var t = new Array(r), e = 0; e < r; e += 1) { t[e] = new Array(r); for (var n = 0; n < r; n += 1) t[e][n] = null } return t }(l = 4 * u + 17), i(0, 0), i(l - 7, 0), i(0, l - 7), h(), c(), d(r, t), 7 <= u && g(r), null == e && (e = p(u, a, n)), v(e, t) }
            var u = r,
                a = m[t],
                s = null,
                l = 0,
                ...
                c = function() { for (var r = 8; r < l - 8; r += 1) null == s[r][6] && (s[r][6] = r % 2 == 0); for (var t = 8; t < l - 8; t += 1) null == s[6][t] && (s[6][t] = t % 2 == 0) },
                h = function() {
            ...
            return f.addData = function(r) {
                var t = L(r);
                n.push(t), e = null
            }, f.isDark = function(r, t) { if (r < 0 || l <= r || t < 0 || l <= t) throw new Error(r + "," + t); return s[r][t] }, f.getModuleCount = function() { return l }, f.make = function() {
                o(!1, function() {
        ...
        o.stringToBytes = function(r) {
            ...
            var i = function() {
                    function r() { var r = t.read(); if (-1 == r) throw new Error; return r }
                    for (var t = S(u), e = 0, n = {};;) {
                        var o = t.read();
                        if (-1 == o) break;
                        var i = r(),
            ...
            return function(r) {
                for (var t = new Array, e = 0; e < r.length; e += 1) {
                    var n = r.charCodeAt(e);
                    if (n < 128) t.push(n);
                    else { var o = i[r.charAt(e)]; "number" == typeof o ? (255 & o) == o ? t.push(o) : (t.push(o >>> 8), t.push(255 & o)) : t.push(a) }
                }
                return t
            }
        };
        ...
        function g() {
            var e = new Array,
                o = {
                    writeByte: function(r) { e.push(255 & r) },
                    writeShort: function(r) { o.writeByte(r), o.writeByte(r >>> 8) },
                    writeBytes: function(r, t, e) { t = t || 0, e = e || r.length; for (var n = 0; n < e; n += 1) o.writeByte(r[n + t]) },
                    writeString: function(r) { for (var t = 0; t < r.length; t += 1) o.writeByte(r.charCodeAt(t)) },
        ...
        function h(r, t) {
            var n = r,
                ...
                l = new Array(r * t),
                e = {
                    setPixel: function(r, t, e) { l[t * n + r] = e },
                    write: function(r) {
                ...
                h = function() {
                    var t = {},
                        ...
                        n = {
                            ...
                            indexOf: function(r) { return t[r] },
                            contains: function(r) { return void 0 !== t[r] }
                        };
                    return n
                };
            return e
        ...
        var d, r, t, e, n = 1,
            ...
            ], (e = {}).getBCHTypeInfo = function(r) { for (var t = r << 10; 0 <= x(t) - x(1335);) t ^= 1335 << x(t) - x(1335); return 21522 ^ (r << 10 | t) }, e.getBCHTypeNumber = function(r) { for (var t = r << 12; 0 <= x(t) - x(7973);) t ^= 7973 << x(t) - x(7973); return r << 12 | t }, e.getPatternPosition = function(r) { return t[r - 1] }, e.getMaskFunction = function(r) {
                switch (r) {
                    case f:
            ...
            }, e.getErrorCorrectPolynomial = function(r) { for (var t = w([1], 0), e = 0; e < r; e += 1) t = t.multiply(w([1, b.gexp(e)], 0)); return t }, e.getLengthInBits = function(r, t) {
            ...
            b = function() { for (var t = new Array(256), e = new Array(256), r = 0; r < 8; r += 1) t[r] = 1 << r; for (r = 8; r < 256; r += 1) t[r] = t[r - 4] ^ t[r - 5] ^ t[r - 6] ^ t[r - 8]; for (r = 0; r < 255; r += 1) e[t[r]] = r; var n = { glog: function(r) { if (r < 1) throw new Error("glog(" + r + ")"); return e[r] }, gexp: function(r) { for (; r < 0;) r += 255; for (; 256 <= r;) r -= 255; return t[r] } }; return n }(),
            C = (d = [
                [1, 26, 19],
                [1, 26, 16],
                [1, 26, 13],
            ...
            B = function() {
                var e = new Array,
                    ...
                    o = {
                        ...
                        getAt: function(r) { var t = Math.floor(r / 8); return 1 == (e[t] >>> 7 - r % 8 & 1) },
                        put: function(r, t) { for (var e = 0; e < t; e += 1) o.putBit(1 == (r >>> t - e - 1 & 1)) },
            ...
            L = function(r) {
                var t = a,
                    e = o.stringToBytes(r),
                    n = { getMode: function() { return t }, getLength: function(r) { return e.length }, write: function(r) { for (var t = 0; t < e.length; t += 1) r.put(e[t], 8) } };
                return n
            },
            S = function(r) {
                var e = r,
                    ...
                    a = function(r) { if (65 <= r && r <= 90) return r - 65; if (97 <= r && r <= 122) return r - 97 + 26; if (48 <= r && r <= 57) return r - 48 + 52; if (43 == r) return 62; if (47 == r) return 63; throw new Error("c:" + r) };
                return t
            },
            A = function(r, t, e, n) {
                ...
                o.write(u);
                for (var f = function() {
                        function e(r) { a += String.fromCharCode(t(63 & r)) }
                        var n = 0,
                            o = 0,
                            i = 0,
                            a = "",
                            ...
                            t = function(r) {
                                if (r < 0);
                                else { if (r < 26) return 65 + r; if (r < 52) return r - 26 + 97; if (r < 62) return r - 52 + 48; if (62 == r) return 43; if (63 == r) return 47 }
                                throw new Error("n:" + r)
                            };
                        return r.writeByte = function(r) { for (n = n << 8 | 255 & r, o += 8, i += 1; 6 <= o;) e(n >>> o - 6), o -= 6 }, r.flush = function() {
                            if (0 < o && (e(n << 6 - o), o = n = 0), i % 3 != 0)
                                for (var r = 3 - i % 3, t = 0; t < r; t += 1) a += "="
                        }, r.toString = function() { return a }, r
        ...
        function x(r) { for (var t = 0; 0 != r;) t += 1, r >>>= 1; return t }
        return o
    }();
    return r = function() { return t }, "function" == typeof define && define.amd ? define([], r) : "object" == typeof exports && (module.exports = r()), t.stringToBytes = function(r) {
        return function(r) {
        ...
        this.each(function() {
            ...
            ! function(o, i) {
                var r = function(r) {
                    ...
                    return t.length && f.each(t, function(r, t) { var e = f.inArray(t, n); - 1 !== e && n.splice(e, 1) }), n
                }(i);
            ...
            function(r, t) {
                ...
                if (!e.length) return;
                e.append('<div class="wechat-qrcode"><h4>' + t.wechatQrcodeTitle + '</h4><div class="qrcode"></div><div class="help">' + t.wechatQrcodeHelper + "</div></div>"), e.find(".qrcode").qrcode({ render: "image", size: t.wechatQrcodeSize, text: t.url }), e.offset().top < 100 && e.find(".wechat-qrcode").addClass("bottom")
            }(t, r), f(this).data("initialized", !0)
        })
    }, f(function() { f(".share-component,.social-share").share() })
}(jQuery);